  ...
  return (
    <div className="container d-flex justify-content-center align-items-center vh-100" style={{ backgroundColor: '#f5f5f5' }}>
      <div className="card p-4 shadow-lg border-0" style={{ width: '100%', maxWidth: '450px', borderRadius: '15px', backgroundColor: '#ffffff' }}>
        <h3 className="card-title mb-4 text-center" style={{ color: '#000000', fontWeight: 'bold' }}>Create an Account</h3>
        <form>
          <div className="mb-3">
          ...
          <div className="mb-3">
            <label htmlFor="confirmPassword" className="form-label" style={{ color: '#000000' }}>Confirm Password</label>
            <input
              type="password"
              className="form-control"
              id="confirmPassword"
        ...
        <p className="mt-3 text-center" style={{ color: '#000000' }}>
          Already have an account? <a href="/signin" style={{ color: '#000000', fontWeight: 'bold' }}>Sign In</a>
        </p>
      </div>
    </div>
  );
